...
Group:          kernel
Source0:        https://cdn.kernel.org/pub/linux/kernel/v6.x/linux-6.6.49.tar.xz
Source1:        config
Source2:        cmdline

%define ktarget  ltscurrent
...
Requires: linux-ltscurrent-license = %{version}-%{release}
...
Summary:        The Linux kernel
Group:          kernel
Requires:       linux-ltscurrent = %{version}-%{release}
Requires:       linux-ltscurrent-extra = %{version}-%{release}
Requires:       linux-ltscurrent-license = %{version}-%{release}
